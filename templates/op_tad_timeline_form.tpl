  ...
  <div class="form-group row mb-3">
    ...
    <div class="col-md-4">
      <div class="input-group">
          ...
          <input type="number" name="year" id="year" class="form-control validate[required, custom[integer], minSize[4], maxSize[4]]" value="<{$year|default:''}>" placeholder="<{$smarty.const._MD_TAD_TIMELINE_YEAR}>">
    ...
    <div class="col-md-2">
      <div class="input-group">
        <input type="number" name="month" id="month" class="form-control validate[custom[integer], min[1], max[12]]" value="<{$month|default:''}>" placeholder="<{$smarty.const._MD_TAD_TIMELINE_MONTH}>">
          <div class="input-group-append input-group-addon">
    ...
    <div class="col-md-2">
      <div class="input-group">
        <input type="number" name="day" id="day" class="form-control validate[custom[integer], min[1], max[31]]" value="<{$day|default:''}>" placeholder="<{$smarty.const._MD_TAD_TIMELINE_DAY}>">
          <div class="input-group-append input-group-addon">
